  ...
  public FakeAwesomeExchangePricesClient() {
    ...
    this.exchangeRates.put(
        ...
        new DailyPriceResponse(
            ...
            BigDecimal.valueOf(0.1674),
            BigDecimal.valueOf(0.1656),
            BigDecimal.valueOf(0),
            BigDecimal.valueOf(0.1656),
            BigDecimal.valueOf(0.1656),
            BigDecimal.valueOf(-0.0006),
            Instant.parse("2024-08-16T23:59:58Z"),
            "2024-08-16 20:59:58"));
    this.exchangeRates.put(
        "BRL-USD",
        new DailyPriceResponse(
            ...
            BigDecimal.valueOf(0.1839),
            BigDecimal.valueOf(0.1822),
            BigDecimal.valueOf(0.16),
            BigDecimal.valueOf(0.1826),
            BigDecimal.valueOf(0.1827),
            BigDecimal.valueOf(0.0003),
            Instant.parse("2024-08-16T20:59:42Z"),
            "2024-08-16 17:59:42"));
    this.exchangeRates.put(
        "BRL-GBP",
        new DailyPriceResponse(
            ...
            BigDecimal.valueOf(0.1367),
            BigDecimal.valueOf(0.1367),
            BigDecimal.valueOf(0.03),
            BigDecimal.valueOf(0.1366),
            BigDecimal.valueOf(0.1366),
            BigDecimal.valueOf(0),
            Instant.parse("2024-09-24T21:03:32Z"),
            "2024-09-24 18:03:32"));
  }

  @Override
  public List<DailyPriceResponse> dailyPrice(String currency, String startDate, String endDate) {
    if (currency.equals("BRL-ERROR"))
